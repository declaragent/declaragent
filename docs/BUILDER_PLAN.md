...
**Status:** Design-frozen for v0.2.0. §11 decisions are binding for the v0.2 freeze; revisit only via changeset. Positioned to land after the v0.1.8 persona work and before any v0.3 multi-model / agent-graph features.
