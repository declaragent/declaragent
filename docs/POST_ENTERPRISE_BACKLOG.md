...
| 48 | [ ] Pre-push hook / CI autofix for `bun run scripts/docs-cli-extract.ts` on CLI-surface PRs | CI | 1 h | Not started | Bit PRs #14, #20, #23 |
| 49 | [ ] Pre-push hook for Biome formatting on `docs-site/sidebars.ts` (recurring drift) | CI | 30 min | Not started | Bit rounds 1, 2 |
